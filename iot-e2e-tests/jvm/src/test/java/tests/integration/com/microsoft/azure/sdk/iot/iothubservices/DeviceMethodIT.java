...
import static com.microsoft.azure.sdk.iot.common.iothubservices.SendMessagesCommon.waitForStabilizedConnection;
...
public class DeviceMethodIT
{
    ...
    private void errorInjectionTestFlow(Message errorInjectionMessage) throws Exception
    {
        ...
        // Assert
        waitForStabilizedConnection(actualStatusUpdates, ERROR_INJECTION_WAIT_TIMEOUT);
        invokeMethodSucceed();
    }
